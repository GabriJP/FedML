...
from fedml_api.distributed.fedavg.FedAvgAPI import fed_ml_fed_avg_distributed
...
if __name__ == "__main__":
    ...
    fed_ml_fed_avg_distributed(args.fl_worker_index, num_FL_workers, device, None,
