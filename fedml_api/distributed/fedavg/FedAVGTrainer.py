...
class FedAVGTrainer:
    ...
    def test(self):
        ...
        train_tot_correct, train_num_sample, train_loss = train_metrics['test_correct'], train_metrics['test_total'], \
                                                          train_metrics['test_loss']

        # test data
        test_metrics = self.trainer.test(self.test_local, self.device)
        test_tot_correct, test_num_sample, test_loss = test_metrics['test_correct'], test_metrics['test_total'], \
