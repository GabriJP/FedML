...
def FedML_FedNAS_distributed(process_id, worker_number, device, comm, model, train_data_num, train_data_global,
                             test_data_global, local_data_num, train_data_local, test_data_local, args):
    if process_id == 0:
...
def init_client(args, device, comm, process_id, worker_number, model, train_data_num, local_data_num, train_data_local,
                test_data_local):
    # trainer
    client_ID = process_id - 1
    trainer = FedNASTrainer(client_ID, train_data_local, test_data_local, local_data_num, train_data_num, model, device,
                            args)
